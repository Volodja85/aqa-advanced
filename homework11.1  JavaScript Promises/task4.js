...
const classTodos = new Todos('https://jsonplaceholder.typicode.com/todos/1').fetchTodo();
const classUsers = new Users('https://jsonplaceholder.typicode.com/users/1').fetchUser();
